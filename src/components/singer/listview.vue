  ...
  <scroll class="listview" ref="scrollComp" @scroll="goto">
    <ul>
      ...
      <li v-for="(singers,i) in singerList" :key="i" class="list-group">
        ...
        <!-- 歌手列表 -->
        <ul>
          <li class="list-group-item" v-for="(singer,i) in singers.singers" :key="i" @click="select(singer)">
